...
#define _tex_gen_3dsmax5_CLASS_ID	Class_ID(0x391acadf, 0x48bfce7c)
...
class _tex_gen_3dsmax5 : public BitmapIO {
	public:
		// Parameter block
		...
		//From Animatable
		Class_ID ClassID() {return _tex_gen_3dsmax5_CLASS_ID;}		
...
class _tex_gen_3dsmax5ClassDesc:public ClassDesc2 {
	public:
	int 			IsPublic() {return 1;}
	void *			Create(BOOL loading = FALSE) {return new _tex_gen_3dsmax5();}
	const TCHAR *	ClassName() {return GetString(IDS_CLASS_NAME);}
	SClass_ID		SuperClassID() {return BMM_IO_CLASS_ID;}
	Class_ID		ClassID() {return _tex_gen_3dsmax5_CLASS_ID;}
	const TCHAR* 	Category() {return GetString(IDS_CATEGORY);}
	const TCHAR*	InternalName() { return _T("_tex_gen_3dsmax5"); }	// returns fixed parsable name (scripter-visible name)
	HINSTANCE		HInstance() { return hInstance; }				// returns owning module handle
};

static _tex_gen_3dsmax5ClassDesc _tex_gen_3dsmax5Desc;
ClassDesc2* Gettex_gen_3dsmax5Desc() {return &_tex_gen_3dsmax5Desc;}

enum { _tex_gen_3dsmax5_params };
...
static ParamBlockDesc2 _tex_gen_3dsmax5_param_blk ( _tex_gen_3dsmax5_params, _T("params"),  0, &_tex_gen_3dsmax5Desc, 
